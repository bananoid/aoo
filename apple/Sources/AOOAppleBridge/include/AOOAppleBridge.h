...
typedef struct AOOAppleSenderStatus {
    ...
    uint64_t currentProcessQueueDepth;
    uint64_t maximumProcessQueueDepth;
    uint64_t pacingCatchUpBlockCount;
    uint64_t pacingReanchorCount;
    ...
    double pacingLatenessMilliseconds;
    double maximumPacingLatenessMilliseconds;
...
typedef struct AOOAppleReceiverStatus {
    ...
    uint64_t socketDatagramObservationCount;
    uint64_t kernelTimestampObservationCount;
    uint64_t staleDatagramCount;
    uint64_t incompleteBlockCount;
    uint64_t emptyBlockCount;
    uint64_t trimmedBacklogBlockCount;
    uint32_t currentBufferedBlockCount;
    uint32_t currentContiguousCompleteBlockCount;
    uint32_t currentMissingBlockStreak;
    uint32_t maximumMissingBlockStreak;
    uint32_t currentResamplerBufferedFrameCount;
    uint32_t currentPlayableFrameCount;
    uint64_t pingEventCount;
    ...
    double latestKernelDatagramGapMilliseconds;
    double maximumKernelDatagramGapMilliseconds;
    double latestKernelToReceiveDelayMilliseconds;
    double maximumKernelToReceiveDelayMilliseconds;
